...
const Header = () => {
  return (
    <>
      <nav className="site-nav dark js-site-navbar mb-5 site-navbar-target" style={{float: "left"}}>
            ...
            <ul className="js-clone-nav d-none d-lg-inline-block site-menu float-left">
              ...
              <li className="has-children" style={{paddingLeft: "70px"}}>
                ...
                <ul className="dropdown">
                  <li >
                    <a href="index.html#testimonials-section" className="nav-link">
                      Pose
                    </a>
                  </li>
                  <li className="active">
              ...
              <li>
                <a href="#features-section" className="nav-link" style={{paddingLeft: "70px"}}>
                  Let`s Start
                </a>
              </li>
              {/* <li>

                        ...
                        <div className="row">
                            ...
                            <div className="col-12">
                                ...
                                <div className="row justify-content-center">
                                    <div className="col-md-7 text-center mb-5" style={{ margin: "30px" }}>
                                    ...
                                    <div className="col-lg-4">
                                        <div className="intro" style={{ position: "relative", top: "-150px" }}>
                                            <div className="excerpt aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                                ...
                                                <h2 className="font-weight-bold">마음의 휴식을 위한 AI요가 가이드</h2>
                                                {/* <p>나를 괴롭히던 고민 대신, 호흡처럼 덜 복잡한 신체 활동으로 관심을 돌린다면 내며의 혼란에서 잠시 벗어날 수 있어요.</p> */}
                                            </div>
                            ...
                            <div className="col-lg-6">
                                <div className="mb-4 aos-init aos-animate bg-light" data-aos="fade-up" data-aos-delay="300">
                                    <div className="untree_co-testimonial d-flex">
                                        ...
                                        <div className="text" style={{ margin: "30px" }}>
                                ...
                                <div className="mb-4 aos-init aos-animate bg-light" data-aos="fade-up" data-aos-delay="300">
                                    <div className="untree_co-testimonial d-flex">
                                        ...
                                        <div className="text" style={{ margin: "30px" }}>
                                            ...
                                            <blockquote>
                                                <span class="highlight"> "저는 FE/BE 개발자입니다."</span>
                                                <p>개발을 진심으로 사랑하고 더 나아가기를 꿈꿉니다.</p>
                                ...
                                <div className="mb-4 aos-init aos-animate bg-light" data-aos="fade-up" data-aos-delay="300">
                                    <div className="untree_co-testimonial d-flex">
                                        <div className="text" style={{ margin: "30px" }}>
                                            ...
                                            <blockquote>
                                                <span class="highlight"> "저는 FE 개발자입니다."</span>
                                                <p>디자인 능력을 갖춘 트렌디한 기술자가 되길 꿈꿉니다.</p>
                                            </blockquote>
                                ...
                                <div className="mb-4 aos-init aos-animate bg-light" data-aos="fade-up" data-aos-delay="300">
                                    <div className="untree_co-testimonial d-flex">
                                        ...
                                        <div className="text" style={{ margin: "30px" }}>
                                            ...
                                            <blockquote>
                                                <span class="highlight"> "저는 BE 개발자입니다."</span>
                                                <p>Data 활용 능력과 빠른 실행력을 겸비한 개발자를 꿈꿉니다. </p>
                                            </blockquote>

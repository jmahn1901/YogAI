                                    ...
                                    <div className="untree_co-testimonial d-flex">
                                        ...
                                        <div className="text">
                                            <div className="author d-flex mb-3">
                                                ...
                                                <div>
                                                    <strong className="d-block font-weight-bold h5 mb-0">심상원(리더)</strong><span className="d-block">github link: https://github.com/swon95</span>
                                                </div>

                                            </div>
                                            <blockquote>
                                                “Separated they <span className="highlight">live in Bookmarksgrove right at the coast of the Semantics</span>, a large language ocean. A small river named Duden flows by their place and supplies it with the necessary regelialia. ”
                                            </blockquote>
                                    ...
                                    <div className="untree_co-testimonial d-flex">
                                        ...
                                        <div className="text">
                                            <div className="author d-flex mb-3">
                                                ...
                                                <div>
                                                    <strong className="d-block font-weight-bold h5 mb-0">권현성</strong><span className="d-block">https://github.com/goodsosbva</span>
                                                </div>
                                    ...
                                    <div className="untree_co-testimonial d-flex">
                                        <div className="text">
                                            <div className="author d-flex mb-3">
                                                ...
                                                <div>
                                                    <strong className="d-block font-weight-bold h5 mb-0">양서진</strong><span className="d-block">github link: https://github.com/zkdk1241</span>
                                                </div>
                                    ...
                                    <div className="untree_co-testimonial d-flex">
                                        ...
                                        <div className="text">
                                            <div className="author d-flex mb-3">
                                                ...
                                                <div>
                                                    <strong className="d-block font-weight-bold h5 mb-0">안정미</strong><span className="d-block">github link: https://github.com/jmahn1901</span>
                                                </div>
                                    ...
                                    <div className="untree_co-testimonial d-flex">
                                        ...
                                        <div className="text">
                                            <div className="author d-flex mb-3">
                                                ...
                                                <div>
                                                    <strong className="d-block font-weight-bold h5 mb-0">허다혜</strong><span className="d-block">github link: https://github.com/hidihi</span>
                                                </div>
